...
public class UserRecyclerViewAdapter2 extends RecyclerView.Adapter<UserRecyclerViewAdapter2.ViewHolder> {

    private List<User> users = new ArrayList<>();
    SetOnClickListener setOnClickListener;

    public UserRecyclerViewAdapter2(Context context){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            setOnClickListener.onUserClick2(users.get(getAdapterPosition()).getId());
        }
    }
}
